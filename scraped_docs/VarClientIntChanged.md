# VarClientIntChanged (RuneLite API 1.12.10 API)

**URL:** https://static.runelite.net/runelite-api/apidocs/net/runelite/api/events/VarClientIntChanged.html
...
| `[VarClientIntChanged](#%3Cinit%3E(int))​(int index)` | |
