# VarClientStrChanged (RuneLite API 1.12.10 API)

**URL:** https://static.runelite.net/runelite-api/apidocs/net/runelite/api/events/VarClientStrChanged.html
...
| `[VarClientStrChanged](#%3Cinit%3E(int))​(int index)` | |
